...
summs(climate_gnbmod3, exp = TRUE) # climate
summ(host_gnb_mod4, exp = TRUE) # host
summ(combo_gnb_mod5, exp = TRUE) # combo

install.packages("flextable")
library(officer)
library(flextable)
export_summs(climate_gnbmod3,host_gnb_mod4,combo_gnb_mod5, scale = TRUE,
...
export_summs(climate_gnbmod3,host_gnb_mod4,combo_gnb_mod5, scale = TRUE,
             error_format = "({statistic}, p = {p.value})",
             to.file = "PDF", 
             file.name = "Tejon_BestFitModels.pdf")
```
